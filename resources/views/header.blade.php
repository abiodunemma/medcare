...
<div class="offcanvas offcanvas-start" tabindex="-1" id="mobileMenu"
    ...
    <div class="offcanvas-body px-3 pt-3">
        <ul class="nav flex-column gap-3" style="font-family: 'Outfit', sans-serif; font-size: 16px;">
            ...
            <li class="nav-item">
                <a href="{{ url('/contact') }}" class="nav-link text-dark d-flex align-items-center gap-2">
        ...
        <div class="mt-4">
            <button class="btn w-100 text-white"
                    style="background-color: #5F6FFF; border-radius: 24px; font-family: 'Outfit', sans-serif;">
